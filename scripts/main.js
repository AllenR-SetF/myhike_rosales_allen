    ...
    db.collection(collection)
        ...
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                newcard.querySelector('i').onclick = () => modifyBookmark(docID);
...
//-----------------------------------------------------------------------------
function modifyBookmark(hikeDocID) {
    currentUser.get().then(userDoc => {
        //get the user name
        var bookmarks = userDoc.data().bookmarks;
        if (bookmarks.includes(hikeDocID)) {
            currentUser.update({
                // Use 'arrayRemove' to add the new bookmark ID to the 'bookmarks' array.
